...
def on_connect(client, userdata, flags, rc):
    ...
    connected_flag = True
    client.subscribe(device_id+"/inTopic")
...
def connect_to_mqtt(client):
    client.tls_set(ca_certs="/home/pi/data40C2/ca.crt", certfile="/home/pi/data40C2/client2.crt", keyfile="/home/pi/data40C2/client2.key", cert_reqs=ssl.CERT_REQUIRED,tls_version=ssl.PROTOCOL_TLS, ciphers=None) 
    client.username_pw_set(username="rudivd",password="rudivd")
    client.connect("iot.xlexit.com", 8883, 60)
...
def main():
  ...
  client = mqtt.Client(client_id=device_id, clean_session=True, userdata=None, protocol=mqtt.MQTTv311)
